...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'models/ReportTypeGroup'], factory);
   ...
   * @module models/ReportTypeGroupsList
   * @version 1.1.1
   */

  /**
   * Constructs a new <code>ReportTypeGroupsList</code>.
   * @alias module:models/ReportTypeGroupsList
   * @class
   */
   ...
   * @param {module:models/ReportTypeGroupsList} obj Optional instance to populate.
   * @return {module:models/ReportTypeGroupsList} The populated <code>ReportTypeGroupsList</code> instance.
   */
  ...
  /**
   * @member {Array.<module:models/ReportTypeGroup>} report_type_groups
   */

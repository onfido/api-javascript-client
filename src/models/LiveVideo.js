...
(function(root, factory) {
   ...
   * @module models/LiveVideo
   * @version 1.6.0
   */

  /**
   * Constructs a new <code>LiveVideo</code>.
   * @alias module:models/LiveVideo
   * @class
   */
   ...
   * @param {module:models/LiveVideo} obj Optional instance to populate.
   * @return {module:models/LiveVideo} The populated <code>LiveVideo</code> instance.
   */

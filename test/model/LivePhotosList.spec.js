...
(function(root, factory) {
  ...
  describe('LivePhotosList', function() {
    it('should create an instance of LivePhotosList', function() {
      ...
      //var instance = new Onfido.LivePhotosList();
      //expect(instance).to.be.a(Onfido.LivePhotosList);
    });

    it('should have the property live_photos (base name: "live_photos")', function() {
      // uncomment below and update the code to test the property live_photos
      //var instance = new Onfido.LivePhotosList();

...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Onfido.CheckCommon();
  });
  ...
  describe('CheckCommon', function() {
    it('should create an instance of CheckCommon', function() {
      // uncomment below and update the code to test CheckCommon
      //var instance = new Onfido.CheckCommon();
      //expect(instance).to.be.a(Onfido.CheckCommon);
    });

...
(function(root, factory) {
  ...
  describe('ReportTypeGroup', function() {
    it('should create an instance of ReportTypeGroup', function() {
      ...
      //var instane = new Onfido.ReportTypeGroup();
    ...
    it('should have the property groupOnly (base name: "group_only")', function() {
      // uncomment below and update the code to test the property groupOnly
      //var instane = new Onfido.ReportTypeGroup();
      //expect(instance).to.be();
    });

    it('should have the property reportTypes (base name: "report_types")', function() {
